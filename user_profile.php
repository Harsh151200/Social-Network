    ...
    <div class="col-sm-12">
            ...
            <?php
                if(isset($_GET['u_id']))
                {
                    ...
                    $userow_id = $row['user_id'];

                    if($userow_id == $user_id){
                        echo "<a href = 'edit_profile.php?u_id = $userow_id' class = 'btn btn-success'>Edit Profile</a>
                        <br><br><br>
                        ";
                    }
            ...
            <div class="col-sm-8">
                 ...
                 <?php
                    ...
                    $select = "select * from posts where user_id = $u_id ORDER BY 1 DESC Limit 5";
                        $run_posts = mysqli_query($con, $select);
                                ...
                                echo "
                                    <div id = 'own_posts'>
                                        <div class = 'row'>
                                            ...
                                            <div>
                                                <h3><a href = 'user_profile.php?u_id = $user_id' 
